...
export default function Header() {
    return (
        <div className="relative w-full h-screen text-black rounded-lg flex flex-col justify-center items-center overflow-hidden">
            ...
            <div className="w-80 h-80 bg-accent absolute top-48 -left-38 blur-3xl overflow-hidden"></div>
            <div className="w-80 h-80 bg-accent absolute bottom-39 -right-38 blur-3xl overflow-hidden"></div>
            ...
            <div className="w-full md:max-w-2xl absolute px-10 md:px-0 text-center flex flex-col justify-center items-center">
                ...
                <div className="mt-3 flex">
                    ...
                    <Link href="/login" className="bg-accent hover:bg-blue-800/80  text-white backdrop-blur-3xl mx-2 px-7 py-3 rounded-2xl transition">
                        شروع یادگیری
                    </Link>
                </div>
            </div>
